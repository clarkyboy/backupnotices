<?php
	...
	$title = $_POST['titlealias'];
    
    $notices = new Notices;	
	
	$chart1 = $notices->load_chart($titleid,$titlealias);
    $chart2 = $notices->load_chart2($titleid,$titlealias);
    $charts1 = array();
    $charts2 = array();
...
?>
<html>
	<title><?php echo $title.'-CHART'; ?></title>
	<head>
		...
		<script>
			...
			function generatePDF(){
				...
				chart["export"].toPDF(layout, function(data) {
				  this.download(data, "application/pdf", "<?php echo $title.'-'.$titleid; ?>.pdf");
				});
			}
	...
	<body style="background:#fff;">
		...
		<div class="chart-bg" id="chart-bg">
			<input type="hidden" id="filename" value="<?php echo $title.'-'.$titleid; ?>">
					...
					<tr>
						<td>
							<div class="innerText2">
								Title : <span id="tblTitle" ><?php echo $title; ?></span>
							</div>	
						</td>
						<td>
							<div class="innerText2">
