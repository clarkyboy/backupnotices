<?php
	...
	$result = $notices->update_status_pattern($id, $geoipisp, $spattern, $sstatus);//function to update table for changes
	//var_dump($result);
	/*
	if($result) 
		{
...
<body>
	<div class="row" style="margin-top:5%;">
		...
		<div class="container">
			...
			<!--display this div if update process is successful based on $result-->
			<div class="col-md-4" style="<?php if(!$result) echo'display:none;';?>">
				<div class="panel panel-success">
				  <div class="panel-heading"><h2 class="text-center">Update Successful</h2></div>
				  <div class="panel-body">
				    ...
				    <a href="statusPaternManagement.php"><span class="btn btn-lg btn-success" style="width:100%;">Continue</span></a>
				  </div>
				</div>
			</div>
			<!--display this div if update process is failed based on $result-->
			<div class="col-md-4" style="<?php if($result) echo'display:none;';?>">
				<div class="panel panel-danger">
				  <div class="panel-heading"><h2 class="text-center">Update Failed</h2></div>
				  <div class="panel-body">
