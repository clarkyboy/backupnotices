<html>
	...
	<body>
		<div class="container box">
			<h1 align="center">Report Recipients</h1>
			<br />
			<div class="table-responsive">
				...
				<div align="right">
					...
					<a id="add_button" data-toggle="modal" data-target="#userModal" href="#"><img src="img/add-item.png">New Recipient</a>
					&nbsp; &nbsp; &nbsp;
					<a href="allocate.php"><img src="img/check.png">Allocate Titles</a>&nbsp;
					&nbsp;
					&nbsp;
					<a href="home.php"><img src="img/home2.png" alt="Home">Home</a>
					&nbsp;
				</div>
				<br /><br />
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="hidden" name="createdBy" id="createdBy" value = "2">
...
$(document).ready(function(){
	...
	$(document).on('submit', '#user_form', function(event){
		...
		if(firstName != '' && lastName != '' && email_add != '')
		{
			$.ajax({
				url:"insert.php",
				method:'POST',
